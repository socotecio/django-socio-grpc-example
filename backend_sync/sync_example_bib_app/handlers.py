...
from sync_example_bib_app.services import AuthorService, PublisherService, PublicationCategoryService, BookService, JournalService

def grpc_handlers(server):
    app_registry = AppHandlerRegistry("sync_example_bib_app", server)
